    ...
    public class PhoneShopContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            List<Role> roles = new List<Role>()
            {
                ...
                new Role(){RoleId = 2 , RoleName = "Staff", CreatedAt = DateTime.ParseExact("2024-07-03 01:46:24.5563387", format, CultureInfo.InvariantCulture), UpdateAt = DateTime.ParseExact("2024-07-03 01:46:24.5563387", format, CultureInfo.InvariantCulture)},
                new Role(){RoleId = 3 , RoleName = "Customer", CreatedAt = DateTime.ParseExact("2024-07-03 01:46:24.5563389", format, CultureInfo.InvariantCulture), UpdateAt = DateTime.ParseExact("2024-07-03 01:46:24.5563389", format, CultureInfo.InvariantCulture)},
            };
            ...
            List<User> users = new List<User>()
            {
                ...
                new User(){UserId = 5 ,FullName = "Nguyen Quoc Duoc", Phone = null, Email = "DuocNQ1@fpt.com", Address = "FSoft Academy", Username = "DuocNQ1", Password = "c1d0e46fdeb2b72758a6a5bd5eecf2622ff8b84a8964c8e9687c6c05c9f474b5", RoleId = roles[1].RoleId,CreatedAt = DateTime.Now, UpdateAt = DateTime.Now },
                ...
                new User(){UserId = 7 ,FullName = "Luu Tung Lam", Phone = null, Email = "LamLT1@fsoft.com", Address = "FSoft Academy", Username = "LamLT1", Password = "c1d0e46fdeb2b72758a6a5bd5eecf2622ff8b84a8964c8e9687c6c05c9f474b5", RoleId = roles[1].RoleId,CreatedAt = DateTime.Now, UpdateAt = DateTime.Now },
            };
