...
namespace Phone_Shop.DataAccess.DBContext
{
    public class PhoneShopContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                new Role(){RoleId = 1 , RoleName = "Admin", CreatedAt = DateTime.ParseExact("2024-07-03 01:46:24.5563385", format, CultureInfo.InvariantCulture), UpdateAt = DateTime.ParseExact("2024-07-03 01:46:24.5563385", format, CultureInfo.InvariantCulture), IsDeleted = false},
                new Role(){RoleId = 2 , RoleName = "Staff", CreatedAt = DateTime.ParseExact("2024-07-03 01:46:24.5563387", format, CultureInfo.InvariantCulture), UpdateAt = DateTime.ParseExact("2024-07-03 01:46:24.5563387", format, CultureInfo.InvariantCulture), IsDeleted = false},
                new Role(){RoleId = 3 , RoleName = "Customer", CreatedAt = DateTime.ParseExact("2024-07-03 01:46:24.5563389", format, CultureInfo.InvariantCulture), UpdateAt = DateTime.ParseExact("2024-07-03 01:46:24.5563389", format, CultureInfo.InvariantCulture), IsDeleted = false},
            };
            ...
            List<User> users = new List<User>()
            {
                ...
                new User(){UserId = 4 ,FullName = "Nguyen Thi Thu", Phone = "0984739845", Email = "oparagreen0@gmail.com", Address = null, Username = "ThuThu", Password = "c1d0e46fdeb2b72758a6a5bd5eecf2622ff8b84a8964c8e9687c6c05c9f474b5", RoleId = roles[2].RoleId,CreatedAt = DateTime.ParseExact("2024-07-03 01:46:24.5563485", format, CultureInfo.InvariantCulture), UpdateAt = DateTime.ParseExact("2024-07-03 01:46:24.5563385", format, CultureInfo.InvariantCulture), IsDeleted = false },
                new User(){UserId = 5 ,FullName = "Nguyen Quoc Duoc", Phone = null, Email = "DuocNQ1@fpt.com", Address = "FSoft Academy", Username = "DuocNQ1", Password = "c1d0e46fdeb2b72758a6a5bd5eecf2622ff8b84a8964c8e9687c6c05c9f474b5", RoleId = roles[1].RoleId,CreatedAt = DateTime.Now, UpdateAt = DateTime.Now, IsDeleted = false },
                new User(){UserId = 6 ,FullName = "Nguyen Anh Tuan", Phone = "6298446654", Email = "", Address = null, Username = "AnhTuan", Password = "c1d0e46fdeb2b72758a6a5bd5eecf2622ff8b84a8964c8e9687c6c05c9f474b5", RoleId = roles[2].RoleId,CreatedAt = DateTime.ParseExact("2024-07-03 01:46:24.5563390", format, CultureInfo.InvariantCulture), UpdateAt = DateTime.ParseExact("2024-07-03 01:46:24.5563390", format, CultureInfo.InvariantCulture), IsDeleted = false },
                new User(){UserId = 7 ,FullName = "Luu Tung Lam", Phone = null, Email = "LamLT1@fsoft.com", Address = "FSoft Academy", Username = "LamLT1", Password = "c1d0e46fdeb2b72758a6a5bd5eecf2622ff8b84a8964c8e9687c6c05c9f474b5", RoleId = roles[1].RoleId,CreatedAt = DateTime.Now, UpdateAt = DateTime.Now, IsDeleted = false },
            };
